...
namespace Interneuron.Terminology.BackgroundTask.API.AppCode.Core
{
    public class APIRequestContextProvider
    {
        ...
        public APIRequestContext CreateAPIContext()
        {
            ...
            var configSection = _configuration.GetSection("TerminologyBackgroundTaskConfig");
            ...
            var terminologyAPIUser = new APIUser
            {
                UserId = "UNKNOWN/SYSTEM"
            };
            ...
            requestContext.APIUser = terminologyAPIUser;

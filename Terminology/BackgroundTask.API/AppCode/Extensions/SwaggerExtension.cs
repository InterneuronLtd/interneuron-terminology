...
using Interneuron.Terminology.BackgroundTask.API.AppCode.Infrastructure.Swagger;
...
namespace Interneuron.Terminology.BackgroundTask.API.AppCode.Extensions
{
    public static class SwaggerExtension
    {
        ...
        public static void AddSwaggerToTerminologyBGTaskApp(this IServiceCollection services, IConfiguration configuration)
        {
        ...
        public static void UseSwaggerToTerminologyBGTaskApp(this IApplicationBuilder app, IConfiguration configuration, IApiVersionDescriptionProvider provider)
        {
            app.UseSwagger();

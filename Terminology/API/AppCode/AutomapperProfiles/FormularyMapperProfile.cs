    ...
    public class FormularyMapperProfile : Profile
    {
        public FormularyMapperProfile()
        {
            ...
            CreateMap<FormularyDetail, FormularyDetailDTO>()
                ...
                .ForMember(dest => dest.ControlledDrugCategories, opt => opt.MapFrom((srcData) => srcData.ControlledDrugCategoryCd.IsNotEmpty() ? new List<FormularyLookupItemDTO> { new FormularyLookupItemDTO { Cd = srcData.ControlledDrugCategoryCd, Desc = srcData.ControlledDrugCategoryDesc, Source = srcData.ControlledDrugCategorySource.IsEmpty()? TerminologyConstants.MANUAL_DATA_SRC: srcData.ControlledDrugCategorySource } } : null))
            ...
            CreateMap<FormularyHeader, ActiveFormularyBasicDTO>()
               .ForMember(dest => dest.CodeSystem, opt => opt.MapFrom(src => src.CodeSystem.IsNotEmpty() ? src.CodeSystem.Trim() : TerminologyConstants.DEFAULT_IDENTIFICATION_CODE_SYSTEM));

            CreateMap<FormularyDetail, ActiveFormularyBasicDetailDTO>()
                .ForMember(dest => dest.CustomWarnings, opt => opt.MapFrom((srcData) => FillCustomWarnings(srcData.CustomWarning)))
                .ForMember(dest => dest.Reminders, opt => opt.MapFrom((srcData) => FillReminders(srcData.Reminder)))
                .ForMember(dest => dest.Endorsements, opt => opt.MapFrom((srcData) => SplitAndFillList(srcData.Endorsement)))
                .ForMember(dest => dest.LocalLicensedUses, opt => opt.MapFrom((srcData) => FillCodeDescList(srcData.LocalLicensedUse)))
            ...
            CreateMap<FormularyAdditionalCode, FormularyAdditionalCodeDTO>()
                ...
                .ForMember(dest => dest.AdditionalCodeOriginal, opt => opt.MapFrom(src => src.AdditionalCode));
            ...
            CreateMap<FormularyDetailDTO, FormularyDetail>()
                ...
                .ForMember(dest => dest.ControlledDrugCategoryDesc, opt => opt.MapFrom(srcData => srcData.ControlledDrugCategories.IsCollectionValid() ? srcData.ControlledDrugCategories.First().Desc : null))
...
;
            ...
            CreateMap<FormularyHistoryModel, FormularyHistoryItemDTO>();
            ...
            CreateMap<PrescriptionPrintingRequiredModel, PrescriptionPrintingRequiredDTO>();
            ...
            CreateMap<FormularyDetailResultModel, FormularyDetailResultDTO>();

            CreateMap<FormularyUsageStat, FormularyUsageStatDTO>();
            CreateMap<FormularyUsageStatDTO, FormularyUsageStat>();
            CreateMap<SaveFormularyUsageStatRequest, FormularyUsageStat>();
            CreateMap<FormularyChangeLog, FormularyChangeLogDTO>();

            CreateMap<FormularyLookupItemDTO, FormularyLookupItemDTO>();
            CreateMap<FormularyLocalRouteDetailDTO, FormularyRouteDetailDTO>();
            CreateMap<FormularyRouteDetailDTO, FormularyLocalRouteDetailDTO>();
        }

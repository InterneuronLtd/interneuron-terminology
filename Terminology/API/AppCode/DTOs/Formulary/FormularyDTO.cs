...
{
    public partial class FormularyDTO : TerminologyResource, IComposeAdditionalCodes, IFormularyDTO
    {
        ...
        //public List<FormularyAdditionalCodeDTO> AllFormularyAdditionalCodes { get; set; }
    ...
    public interface IFormularyDTO
    {
        public string FormularyId { get; set; }
        public int? VersionId { get; set; }
        public string FormularyVersionId { get; set; }

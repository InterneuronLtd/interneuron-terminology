...
namespace Interneuron.Terminology.API.AppCode.Queries
{
    public partial class SnomedCTQueries : ISnomedCTQueries
    {
        ...
        public List<SnomedTradeFamiliesDTO> GetTradeFamilyForConceptIds(List<string> conceptIds, bool ignoreFromCache = false)
        {
        ...
        public List<SnomedModifiedReleaseDTO> GetModifiedReleaseForConceptIds(List<string> conceptIds, bool ignoreCacheSource = false)
        {

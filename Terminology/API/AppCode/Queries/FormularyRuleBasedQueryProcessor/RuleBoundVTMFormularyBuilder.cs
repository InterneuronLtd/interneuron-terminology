...
namespace Interneuron.Terminology.API.AppCode.Queries
{
    public class RuleBoundVTMFormularyBuilder : RuleBoundBaseFormularyBuilder
    {
        ...
        //protected void ProjectClassificationCodesFromChildNodes(bool getAllAdditionalCodes)
        //{
        ...
        //                    {
        //                        cloned.AdditionalCode = cloned.AdditionalCode.Substring(0, 7);
        //                    }
        ...
        //            //var filterListOfClassificationCodes = new HashSet<string>();

        //            //foreach (var item in csItem.Value.Values)
        //            //{
        //            //    if (item == null || filterListOfClassificationCodes.Contains($"{item.AdditionalCodeSystem}:{item.AdditionalCode}")) continue;
        //            //    _formularyDTO.AllFormularyAdditionalCodes.Add(item);
        //            //}

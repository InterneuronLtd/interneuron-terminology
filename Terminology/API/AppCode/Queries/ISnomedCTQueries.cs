...
namespace Interneuron.Terminology.API.AppCode.Queries
{
    public interface ISnomedCTQueries
    {
        ...
        List<SnomedTradeFamiliesDTO> GetTradeFamilyForConceptIds(List<string> conceptIds, bool ignoreCacheSource = false);

        List<SnomedModifiedReleaseDTO> GetModifiedReleaseForConceptIds(List<string> conceptIds, bool ignoreCacheSource = false);
    }
}

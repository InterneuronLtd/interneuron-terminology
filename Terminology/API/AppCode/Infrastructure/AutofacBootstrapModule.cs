...
namespace Interneuron.Terminology.API.AppCode.Infrastructure.AutofacBootstrap
{
    public class AutofacBootstrapModule : Autofac.Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<CacheHandlerService>().SingleInstance();

            //https://stackoverflow.com/questions/56020444/how-to-inject-ihostedservice-in-dependecy-injection-from-autofac-module
            builder.RegisterType<BackgroundTaskQueue>().As<IBackgroundTaskQueue>().SingleInstance();
            builder.RegisterType<QueuedHostedService>().As<IHostedService>().SingleInstance();

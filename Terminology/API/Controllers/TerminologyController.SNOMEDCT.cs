...
namespace Interneuron.Terminology.API.Controllers
{
    ...
    public partial class TerminologyController : ControllerBase
    {
        ...
        private readonly IDMDCommand _dmdCommand;

        public TerminologyController(ILogger<TerminologyController> logger, IServiceProvider provider, ISnomedCTQueries snomedCTQueries, IDMDQueries dmdQueries, IDMDCommand dmdCommand)
        {
            this._logger = logger;
        ...
        [HttpPost, Route("gettradefamilyforconceptids")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status410Gone)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<List<SnomedTradeFamiliesDTO>>> GetTradeFamilyForConceptIds(List<string> conceptIds, [FromHeader] bool ignoreCacheSource = false)
        {
            ...
            {
                var results = this._snomedCTQueries.GetTradeFamilyForConceptIds(conceptIds, ignoreCacheSource);
        ...
        [HttpPost, Route("getmodifiedreleaseforconceptids")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status410Gone)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<List<SnomedModifiedReleaseDTO>>> GetModifiedReleaseForConceptIds(List<string> conceptIds, [FromHeader] bool ignoreCacheSource = false)
        {
            ...
            {
                var results = this._snomedCTQueries.GetModifiedReleaseForConceptIds(conceptIds, ignoreCacheSource);

...
namespace Interneuron.Terminology.Utility.Models
{
    public partial class mmc_dbContext : DbContext
    {
        ...
        public virtual DbSet<FormularyUsageStats> FormularyUsageStats { get; set; }
        public virtual DbSet<LookupCommon> LookupCommon { get; set; }

        public mmc_dbContext(DbContextOptions<mmc_dbContext> options) : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FormularyHeader>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.FormularyId, e.VersionId }, "formulary_header_formulary_id_idx");

...
> dotnet ef dbcontext scaffold "Server=interneuron-ind-db-test.cjdliyabgdwt.ap-south-1.rds.amazonaws.com;User Id=Inddbtestadmin;Password=N3ur0n!inddbtest;Database=mmc_dev_delta;Port=5432;" -o ..\Model\DomainModels --context-dir DBModelsContext --schema=local_formulary -c TerminologyDBContext Npgsql.EntityFrameworkCore.PostgreSQL -f
